...
public class kelvin_sit_up_invitation extends Fragment implements View.OnTouchListener{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_kelvin_sit_up_invitation, null);
        view.setOnTouchListener(this);
        final Button button_of_sit_up_invitation_confirm=(Button)view.findViewById(R.id.button_of_sit_up_invitation_confirm);
