 ...
 */
public class KelvinAerobicExerciseFragment extends Fragment implements FragmentBackHandler {
    ...
    private ColumnChartView chart_of_aerobic_Exercise_today_record;
    private ColumnChartData data_of_aerobic_Exercise_today_record;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        button_of_invitation.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                getActivity().getSupportFragmentManager()
                        .beginTransaction()
                        .replace(R.id.fragment_kelvin_running_invitation,new kelvin_aerobic_exercise_invitation(),null)
                        .addToBackStack(null)
                        .commit();
            }
        ...
        button_of_task_execution.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(getContext(),Aerobic_exercise_task.class);
                startActivity(intent);
    ...
    private void generateDefaultData() {
        ...
        for (int i = 0; i < numColumns; ++i) {
            ...
            for (int j = 0; j < numSubcolumns; ++j) {
                values.add(new SubcolumnValue((float) Math.random() * 10f + 5, ChartUtils.COLOR_RED));
            }
        ...
        data_of_aerobic_Exercise_today_record = new ColumnChartData(columns);
        ...
        if (hasAxes) {
            ...
            data_of_aerobic_Exercise_today_record.setAxisXBottom(axisX);
            data_of_aerobic_Exercise_today_record.setAxisYLeft(axisY);
        } else {
            data_of_aerobic_Exercise_today_record.setAxisXBottom(null);
            data_of_aerobic_Exercise_today_record.setAxisYLeft(null);
        }

        chart_of_aerobic_Exercise_today_record.setColumnChartData(data_of_aerobic_Exercise_today_record);
