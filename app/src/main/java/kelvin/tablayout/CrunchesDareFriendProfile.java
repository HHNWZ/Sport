    ...
    protected void onCreate(Bundle savedInstanceState) {
                    ...
                    public void onDataChange(DataSnapshot dataSnapshot) {
                        if(dataSnapshot.hasChild(friend_id)){
                            ...
                            if(req_type.equals("接收")){
                                dare_state="接收請求";
                                mProfileSendReqBtn.setText("接受仰臥起坐挑戰請求");
        ...
        mProfileSendReqBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                            ...
                            if (SDK_INT > 8) {
                                ...
                                try {
                                    ...
                                    String strJsonBody = "{"
                                            ...
                                            + "\"contents\": {\"en\": \"Friend req\",\"zh-Hant\": \""+my_name.toString()+"發送仰臥起坐挑戰給你"+"\"}"
                                            + "}";
                        ...
                        public void onSuccess(Void aVoid) {
                            ReqCrunchesDareDatabase.child(friend_id).child(mCurrent_user.getUid()).removeValue().addOnSuccessListener(new OnSuccessListener<Void>() {
                                ...
                                public void onSuccess(Void aVoid) {
                                    mProfileSendReqBtn.setEnabled(true);
                                    dare_state="還沒有發送";
                                    mProfileSendReqBtn.setText("發送仰臥起坐挑戰請求");
                                }
                            });
                        }
                    });
                            ...
                            if (SDK_INT > 8) {
                                ...
                                try {
                                    ...
                                    String strJsonBody = "{"
                                            ...
                                            + "\"data\": {\"activityToBeOpened\":\"CrunchesDareFriendProfile\",\"user_id\": \""+mAuth.getCurrentUser().getUid()+"\"},"
                                            + "\"contents\": {\"en\": \"Friend req\",\"zh-Hant\": \""+my_name.toString()+"拒絕你的仰臥起坐挑戰"+"\"}"
                                            + "}";
                            ...
                            if (SDK_INT > 8) {
                                ...
                                try {
                                    ...
                                    String strJsonBody = "{"
                                            ...
                                            + "\"filters\": [{\"field\": \"tag\", \"key\": \"Uid\", \"relation\": \"=\", \"value\": \""+Fid+"\"}],"
                                            + "\"data\": {\"activityToBeOpened\":\"CrunchesDareFriendProfile\",\"user_id\": \""+mAuth.getCurrentUser().getUid()+"\"},"
                                            + "\"contents\": {\"en\": \"Friend req\",\"zh-Hant\": \""+my_name.toString()+"接受你的仰臥起坐挑戰給你"+"\"}"
                                            + "}";
                ...
                //----取消仰臥起坐挑戰---///
                if(dare_state.equals("仰臥起坐挑戰執行中")){
                            ...
                            if (SDK_INT > 8) {
                                ...
                                try {
                                    ...
                                    String strJsonBody = "{"
                                            ...
                                            + "\"android_sound\": \"messagechat\","
                                            + "\"data\": {\"activityToBeOpened\":\"CrunchesDareFriendProfile\",\"user_id\": \""+mAuth.getCurrentUser().getUid()+"\"},"
                                            + "\"contents\": {\"en\": \"Friend req\",\"zh-Hant\": \""+my_name.toString()+"取消和你的仰臥起坐挑戰"+"\"}"
                                            + "}";
                        ...
                        if (SDK_INT > 8) {
                            ...
                            try {
                                ...
                                String strJsonBody = "{"
                                        ...
                                        + "\"filters\": [{\"field\": \"tag\", \"key\": \"Uid\", \"relation\": \"=\", \"value\": \""+Fid+"\"}],"
                                        + "\"data\": {\"activityToBeOpened\":\"CrunchesDareFriendProfile\",\"user_id\": \""+mAuth.getCurrentUser().getUid()+"\"},"
                                        + "\"contents\": {\"en\": \"Friend req\",\"zh-Hant\": \""+my_name.toString()+"拒絕你的仰臥起坐挑戰邀請"+"\"}"
                                        + "}";
