...
public class StartDateFragment extends DialogFragment implements DatePickerDialog.OnDateSetListener {
    public String date;
    public  static final String DAY_OF_START_Date_PICKER_FRAGMENT="day_of_start_date_picker_fragment";
    public  static final String MONTH_OF_START_Date_PICKER_FRAGMENT="month_of_start_date_picker_fragment";
    public  static final String YEAR_OF_START_Date_PICKER_FRAGMENT="year_of_start_date_picker_fragment";
    public String day;
    public String month;
    public String year1;
