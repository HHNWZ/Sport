...
public class YogaDareFriendProfile extends AppCompatActivity {
    private Toolbar yoga_dare_friend_profile_toolbar;
    ...
    private DatabaseReference ReqYogaDareDatabase;
    private DatabaseReference YogaDareDatabase;
    ...
    public static String Yoga_Dare_Req="Yoga_Dare_Req";
    public static String Yoga_Dare="Yoga_Dare";
    public String Uid;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        OneSignal.startInit(this)
                ...
                .init();
        yoga_dare_friend_profile_toolbar=(Toolbar)findViewById(R.id.yoga_dare_friend_profile_toolbar);
        setSupportActionBar(yoga_dare_friend_profile_toolbar);
                    ...
                    public void onDataChange(DataSnapshot dataSnapshot) {
                        if(dataSnapshot.hasChild(friend_id)){
                            ...
                            if(req_type.equals("接收")){
                                dare_state="接收請求";
                                mProfileSendReqBtn.setText("接受瑜伽挑戰請求");
        ...
        mProfileSendReqBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(dare_state.equals("還沒有發送")){
                    ...
                    requestMap.put(""+Yoga_Dare_Req+"/" + mCurrent_user.getUid() + "/" + friend_id + "/request_type", "發送");
                    requestMap.put(""+Yoga_Dare_Req+"/" + friend_id + "/" + mCurrent_user.getUid() + "/request_type", "接收");
                    ...
                    mRootRef.updateChildren(requestMap, new DatabaseReference.CompletionListener() {
                        ...
                        public void onComplete(DatabaseError databaseError, DatabaseReference databaseReference) {
                            if(databaseError != null){
                                ...
                                Toast.makeText(YogaDareFriendProfile.this, "發送請求時出錯", Toast.LENGTH_SHORT).show();
                            }else{
                                dare_state = "發送請求";
                                mProfileSendReqBtn.setText("取消瑜伽挑戰請求");
                            }
                ...
                if(dare_state.equals("發送請求")){
                    ReqYogaDareDatabase.child(mCurrent_user.getUid()).child(friend_id).removeValue().addOnSuccessListener(new OnSuccessListener<Void>() {
                        @Override
                        public void onSuccess(Void aVoid) {
                            ReqYogaDareDatabase.child(friend_id).child(mCurrent_user.getUid()).removeValue().addOnSuccessListener(new OnSuccessListener<Void>() {
                                @Override
                                public void onSuccess(Void aVoid) {
                                    mProfileSendReqBtn.setEnabled(true);
                                    dare_state="還沒有發送";
                                    mProfileSendReqBtn.setText("發送瑜伽挑戰請求");
                                }
                            });
                        }
                    });
                            ...
                            if (SDK_INT > 8) {
                                ...
                                try {
                                    ...
                                    String strJsonBody = "{"
                                            ...
                                            + "\"data\": {\"activityToBeOpened\":\"YogaDareFriendProfile\",\"user_id\": \""+mAuth.getCurrentUser().getUid()+"\"},"
                                            + "\"contents\": {\"en\": \"Friend req\",\"zh-Hant\": \""+my_name.toString()+"拒絕你的瑜伽挑戰"+"\"}"
                                            + "}";
                ...
                if(dare_state.equals("接收請求")){
                    ...
                    friendsMap.put(""+Yoga_Dare+"/" + mCurrent_user.getUid() + "/id", friend_id);
                    friendsMap.put(""+Yoga_Dare+"/" + friend_id + "/id", mCurrent_user.getUid());

                    friendsMap.put(""+Yoga_Dare_Req+"/" + mCurrent_user.getUid() + "/" +friend_id, null);
                    friendsMap.put(""+Yoga_Dare_Req+"/" + friend_id + "/" + mCurrent_user.getUid(), null);
                    ...
                    mRootRef.updateChildren(friendsMap, new DatabaseReference.CompletionListener() {
                        ...
                        public void onComplete(DatabaseError databaseError, DatabaseReference databaseReference) {
                            ...
                            if(databaseError == null){
                                ...
                                Toast.makeText(YogaDareFriendProfile.this, error, Toast.LENGTH_SHORT).show();
                            }
                        }
                    });
                    AsyncTask.execute(new Runnable() {
                            ...
                            if (SDK_INT > 8) {
                                ...
                                try {
                                    ...
                                    String strJsonBody = "{"
                                            ...
                                            + "\"filters\": [{\"field\": \"tag\", \"key\": \"Uid\", \"relation\": \"=\", \"value\": \""+Fid+"\"}],"
                                            + "\"data\": {\"activityToBeOpened\":\"YogaDareFriendProfile\",\"user_id\": \""+mAuth.getCurrentUser().getUid()+"\"},"
                                            + "\"contents\": {\"en\": \"Friend req\",\"zh-Hant\": \""+my_name.toString()+"接受你的瑜伽挑戰給你"+"\"}"
                                            + "}";
                ...
                //----取消瑜伽挑戰---///
                if(dare_state.equals("瑜伽挑戰執行中")){
                    Map unfriendMap = new HashMap();
                    unfriendMap.put(""+Yoga_Dare+"/" + mCurrent_user.getUid() + "/" + friend_id, null);
                    unfriendMap.put(""+Yoga_Dare+"/" + friend_id + "/" + mCurrent_user.getUid(), null);
                            ...
                            if (SDK_INT > 8) {
                                ...
                                try {
                                    ...
                                    String strJsonBody = "{"
                                            ...
                                            + "\"android_sound\": \"messagechat\","
                                            + "\"data\": {\"activityToBeOpened\":\"YogaDareFriendProfile\",\"user_id\": \""+mAuth.getCurrentUser().getUid()+"\"},"
                                            + "\"contents\": {\"en\": \"Friend req\",\"zh-Hant\": \""+my_name.toString()+"取消和你的瑜伽挑戰"+"\"}"
                                            + "}";
                        ...
                        if (SDK_INT > 8) {
                            ...
                            try {
                                ...
                                String strJsonBody = "{"
                                        ...
                                        + "\"filters\": [{\"field\": \"tag\", \"key\": \"Uid\", \"relation\": \"=\", \"value\": \""+Fid+"\"}],"
                                        + "\"data\": {\"activityToBeOpened\":\"YogaDareFriendProfile\",\"user_id\": \""+mAuth.getCurrentUser().getUid()+"\"},"
                                        + "\"contents\": {\"en\": \"Friend req\",\"zh-Hant\": \""+my_name.toString()+"拒絕你的瑜伽挑戰邀請"+"\"}"
                                        + "}";
