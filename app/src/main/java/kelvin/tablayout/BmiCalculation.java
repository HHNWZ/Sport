            ...
            public void onClick(View v) {
                        ...
                        || "".equals(edi2.getText().toString())) )//避免沒有輸入參數
                {
                    ...
                    if(a2<18.5)
                    {
                        ...
                        tviw31.setTextColor(0xffffffff);
                        tviw32.setTextColor(0xffffffff);
                        tviw36.setTextColor(0xffffffff);
                        tviw37.setTextColor(0xffffffff);
                        tviw38.setTextColor(0xffffffff);
                        tviw28.setTextColor(0xffffffff);
                        tviw27.setTextColor(0xffffffff);
                        tviw33.setTextColor(0xffffffff);
                        tviw34.setTextColor(0xffffffff);
                        tviw35.setTextColor(0xffffffff);
                    ...
                    else if (18.5 <= a2 && a2< 24)
                    {
                        ...
                        tviw30.setTextColor(0xffffffff);
                        tviw32.setTextColor(0xffffffff);
                        tviw36.setTextColor(0xffffffff);
                        tviw37.setTextColor(0xffffffff);
                        tviw38.setTextColor(0xffffffff);
                        tviw29.setTextColor(0xffffffff);
                        tviw27.setTextColor(0xffffffff);
                        tviw33.setTextColor(0xffffffff);
                        tviw34.setTextColor(0xffffffff);
                        tviw35.setTextColor(0xffffffff);
